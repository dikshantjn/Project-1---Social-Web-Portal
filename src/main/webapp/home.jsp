...
function share() {
		...
		$.post("Tweet", post_data, function(data) {
			...
			var url = "https://www.facebook.com/dialog/send?app_id=647621369351251";
		    url = url + "&link=" + share_url;
		    url = url + "&redirect_uri=https://apps.facebook.com/647621369351251/?fb_source=feed";
		    window.open(url);
	} );
...
function testAPI() {
	...
	<div id="status" class="well" style="width: 800px; margin: 0 auto;">
		<h1 class="lead">
			<strong>Welcome to our Twit app</strong>
		</h1>
		<p>Post on facebook like twitter</p>
		...
		<div class="row">
			<div class="span4 offset4">
				...
				var post = function() {
					...
					var url = "https://www.facebook.com/dialog/share?app_id=647621369351251&href=https://twit-275101.df.r.appspot.com/"
			        url = url + "&quote=" + text;
					window.open(url);
				}
				</script>
